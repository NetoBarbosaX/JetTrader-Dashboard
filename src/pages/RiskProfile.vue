<template>
    <div v-if="user.profile == null && recommendationProfile == ''" class="grid p-fluid">
        <div class="col-12 md:col-12">
            ...
            <div class="card" style="justify-content: space-between">
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="r3" name="city" value="3" v-model="answers[0]" />
            ...
            <div class="card" style="justify-content: space-between">
                <div class="field-radiobutton">
                    <RadioButton inputId="city1" name="city" value="1" v-model="answers[1]" />
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city2" name="city" value="2" v-model="answers[1]" />
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city3" name="city" value="3" v-model="answers[1]" />
            ...
            <div class="card" style="justify-content: space-between">
                <div class="field-radiobutton">
                    <RadioButton inputId="city1" name="city" value="1" v-model="answers[2]" />
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city2" name="city" value="2" v-model="answers[2]" />
                    <label for="city2">My tolerance is acceptable for small losses and risks in search of significant returns.</label>
                </div>
                <div class="field-radiobutton">
                    <RadioButton inputId="city3" name="city" value="3" v-model="answers[2]" />
            ...
            <div class="card" style="justify-content: space-between">
                <div class="field-radiobutton">
                    <RadioButton inputId="city1" name="city" value="1" v-model="answers[3]" />
                    <label for="city1"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city2" name="city" value="2" v-model="answers[3]" />
                    <label for="city2"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city3" name="city" value="3" v-model="answers[3]" />
                    <label for="city3"
            ...
            <div class="card" style="justify-content: space-between">
                <div class="field-radiobutton">
                    <RadioButton inputId="city1" name="city" value="1" v-model="answers[4]" />
                    <label for="city1"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city2" name="city" value="2" v-model="answers[4]" />
                    <label for="city2"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city3" name="city" value="3" v-model="answers[4]" />
                    <label for="city3"
            ...
            <div class="card" style="justify-content: space-between">
                <div class="field-radiobutton">
                    <RadioButton inputId="city1" name="city" value="1" v-model="answers[5]" />
                    <label for="city1"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city2" name="city" value="2" v-model="answers[5]" />
                    <label for="city2"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city3" name="city" value="3" v-model="answers[5]" />
                    <label for="city3"
            ...
            <div class="card" style="justify-content: space-between">
                <div class="field-radiobutton">
                    <RadioButton inputId="city1" name="city" value="1" v-model="answers[6]" />
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city2" name="city" value="2" v-model="answers[6]" />
                    <label for="city2"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city3" name="city" value="3" v-model="answers[6]" />
                    <label for="city3"
            ...
            <div class="card" style="justify-content: space-between">
                <div class="field-radiobutton">
                    <RadioButton inputId="city1" name="city" value="1" v-model="answers[7]" />
                    <label for="city1"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city2" name="city" value="2" v-model="answers[7]" />
                    <label for="city2"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city3" name="city" value="3" v-model="answers[7]" />
            ...
            <div class="card" style="justify-content: space-between">
                <div class="field-radiobutton">
                    <RadioButton inputId="city1" name="city" value="1" v-model="answers[8]" />
                    <label for="city1"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city2" name="city" value="2" v-model="answers[8]" />
                    <label for="city2"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city4" name="city" value="3" v-model="answers[8]" />
                    <label for="city4"
            ...
            <div class="card" style="justify-content: space-between">
                <div class="field-radiobutton">
                    <RadioButton inputId="city1" name="city" value="1" v-model="answers[9]" />
                    <label for="city1"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city2" name="city" value="2" v-model="answers[9]" />
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city3" name="city" value="3" v-model="answers[9]" />
            ...
            <div class="card" style="justify-content: space-between">
                <div class="field-radiobutton">
                    <RadioButton inputId="city1" name="city" value="1" v-model="answers[10]" />
                    <label for="city1"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city2" name="city" value="2" v-model="answers[10]" />
                    <label for="city2"
                ...
                <div class="field-radiobutton">
                    <RadioButton inputId="city3" name="city" value="3" v-model="answers[10]" />
                    <label for="city3"
    ...
    <div v-else class="grid p-fluid" style="justify-content: end">
        <div class="col-12 md:col-12">
            <div style="padding-bottom: 25px">
                ...
                >
                    <h3>Recommended Profile - {{ recommendationProfile }}</h3>
                </div>
            ...
            <SelectButton v-model="selectedProfile" :options="selectButtonValues1" optionLabel="name" />
        </div>
...
export default {
    data() {
        return {
            ...
            selectedProfile: '',
            selectButtonValues1: [{ name: 'conservative' }, { name: 'moderate' }, { name: 'aggressive' }],
            profile: [
                {
                    name: 'Conservative',
                    code: 'O1',
    ...
    methods: {
        ...
        async processProfile() {
            (this.riskprofile = true),
                await RIKSPROFILE.sendData(this.vetorToNumber(this.answers)).then((r) => {
                    this.recommendationProfile = r.recommended;
                    console.log(this.recommendationProfile);
                });
        },
        ...
        vetorToNumber(answers) {
            return answers.map((item) => Number(item));
        },
    },
    computed: {
        ...
        vetorNumber() {
            return this.vetorToNumber(this.answers);
        },
        valueStatus() {
            var n = this.recommendationProfile;
            return n === 'conservative' ? 1 : n === 'moderate' ? 2 : 3;
        },
    },
};
</script>
