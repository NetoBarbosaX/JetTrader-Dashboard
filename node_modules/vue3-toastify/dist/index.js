...
var require_get_method = __commonJS({
  "node_modules/core-js/internals/get-method.js"(exports, module2) {
    ...
    module2.exports = function(V, P) {
      var func = V[P];
      return isNullOrUndefined(func) ? void 0 : aCallable3(func);
    };
  }
});
...
var require_internal_state = __commonJS({
  "node_modules/core-js/internals/internal-state.js"(exports, module2) {
    ...
    var enforce = function(it) {
      return has2(it) ? get2(it) : set6(it, {});
    };
    var getterFor = function(TYPE2) {
      return function(it) {
        var state;
        if (!isObject(it) || (state = get2(it)).type !== TYPE2) {
...
var require_a_map = __commonJS({
  "node_modules/core-js/internals/a-map.js"(exports, module2) {
...
var require_map_iterate = __commonJS({
  "node_modules/core-js/internals/map-iterate.js"(exports, module2) {
    var uncurryThis = require_function_uncurry_this();
    var iterateSimple = require_iterate_simple();
    var MapHelpers5 = require_map_helpers();
    var Map5 = MapHelpers5.Map;
    var MapPrototype = MapHelpers5.proto;
    var forEach = uncurryThis(MapPrototype.forEach);
    var entries = uncurryThis(MapPrototype.entries);
    var next = entries(new Map5()).next;
    module2.exports = function(map, fn, interruptible) {
...
var aMap3 = require_a_map();
var MapHelpers = require_map_helpers();
var iterate2 = require_map_iterate();
...
$3({
  ...
  filter: function filter(callbackfn) {
    ...
    var newMap = new Map2();
    iterate2(map, function(value, key) {
      if (boundFunction(value, key, map))
...
var aMap4 = require_a_map();
var iterate3 = require_map_iterate();
$4({
  target: "Map",
  proto: true,
  real: true,
  ...
  find: function find(callbackfn) {
    ...
    var result = iterate3(map, function(value, key) {
      if (boundFunction(value, key, map))
        return {
          value
        };
...
var aMap5 = require_a_map();
var iterate4 = require_map_iterate();
$5({
  target: "Map",
  proto: true,
  real: true,
  ...
  findKey: function findKey(callbackfn) {
    ...
    var result = iterate4(map, function(value, key) {
      if (boundFunction(value, key, map))
        return {
          key
        };
...
var aMap6 = require_a_map();
var iterate5 = require_map_iterate();
$6({
  target: "Map",
  proto: true,
  real: true,
  ...
  includes: function includes(searchElement) {
    return iterate5(aMap6(this), function(value) {
...
var aMap7 = require_a_map();
var iterate6 = require_map_iterate();
$7({
  target: "Map",
  proto: true,
  real: true,
  ...
  keyOf: function keyOf(searchElement) {
    var result = iterate6(aMap7(this), function(value, key) {
...
var aMap8 = require_a_map();
var MapHelpers2 = require_map_helpers();
var iterate7 = require_map_iterate();
var Map3 = MapHelpers2.Map;
var set2 = MapHelpers2.set;
$8({
  target: "Map",
  proto: true,
  real: true,
  ...
  mapKeys: function mapKeys(callbackfn) {
    ...
    var newMap = new Map3();
    iterate7(map, function(value, key) {
...
var aMap9 = require_a_map();
var MapHelpers3 = require_map_helpers();
var iterate8 = require_map_iterate();
var Map4 = MapHelpers3.Map;
var set3 = MapHelpers3.set;
$9({
  target: "Map",
  proto: true,
  real: true,
  ...
  mapValues: function mapValues(callbackfn) {
    ...
    var newMap = new Map4();
    iterate8(map, function(value, key) {
      set3(newMap, key, boundFunction(value, key, map));
    });
    return newMap;
  }
});
...
var aMap10 = require_a_map();
var iterate9 = require_iterate();
var set4 = require_map_helpers().set;
$10({
  target: "Map",
  proto: true,
  real: true,
  ...
  merge: function merge(iterable) {
    ...
    while (i < argumentsLength) {
      iterate9(arguments[i++], function(key, value) {
        set4(map, key, value);
      }, {
        AS_ENTRIES: true
      });
...
var aMap11 = require_a_map();
var iterate10 = require_map_iterate();
...
$11({
  ...
  reduce: function reduce(callbackfn) {
    ...
    iterate10(map, function(value, key) {
      if (noInitial) {
        noInitial = false;
        accumulator = value;
      } else {
...
var aMap12 = require_a_map();
var iterate11 = require_map_iterate();
$12({
  target: "Map",
  proto: true,
  real: true,
  ...
  some: function some(callbackfn) {
    ...
    return iterate11(map, function(value, key) {
      if (boundFunction(value, key, map))
        return true;
    }, true) === true;
  }
...
var aMap13 = require_a_map();
var MapHelpers4 = require_map_helpers();
var $TypeError2 = TypeError;
var get = MapHelpers4.get;
var has = MapHelpers4.has;
var set5 = MapHelpers4.set;
$13({
  target: "Map",
  proto: true,
  real: true,
  ...
  update: function update(key, callback) {
    ...
    var value = isPresentInMap ? get(map, key) : aCallable2(length > 2 ? arguments[2] : void 0)(key, map);
    set5(map, key, callback(value, key, map));
    return map;
  }
});
